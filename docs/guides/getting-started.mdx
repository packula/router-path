...
import Sandbox from '../../website/src/components/Sandbox.js'
...
To create a path pattern, call the [`path`] function by using it as a [tagged
template literal]:
...
<!-- https://codesandbox.io/s/snout-router-path-getting-started-t56te -->
<Sandbox id='snout-router-path-getting-started-t56te' height='300px' />

:::tip

This embedded example doesn't have great TypeScript support.
[Open the full Sandbox](https://codesandbox.io/s/snout-router-path-getting-started-t56te)
...
Using TypeScript? One of the great things about **Snout Router Path** is the way
it infers type information for your path patterns. You can have more confidence
when matching and building paths, because TypeScript will warn you when you're
using your patterns incorrectly:
...
[Try this example in the TypeScript Playground](https://www.typescriptlang.org/play?#)
