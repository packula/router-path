...
<Sandbox id='snout-router-path-getting-started-t56te' height='300px' codeMirror hideDevTools previewWindow='console' />

:::tip

This embedded example doesn't have great TypeScript support.
[Open the full Sandbox](https://codesandbox.io/s/snout-router-path-getting-started-t56te?from-embed)
